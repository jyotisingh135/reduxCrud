...
class FormModal extends Component{
    ...
    handleSubmit=(e)=>{
       // e.preventDefault();
        ...
        {
            this.props.updateUser(this.props.Obj);
        }
    }
    handleClear=()=>{
        var valobj={
                            ...
                            <form className='container-fluid'>
                                ...
                                <div>
                                    <select className='form-control'  onChange={this.handleState} >
                                        <option>{this.props.Obj.state?this.props.Obj.state:'-----select-----'}</option>
                                        {
                                ...
                                <div>
                                    <select className='form-control'  onChange={this.handleCity}>
                                        <option>{this.props.Obj.city?this.props.Obj.city:'-----select-----'}</option>
                                        {
